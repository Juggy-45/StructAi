  ...
  return (
    <div className='page-wrapper relative z-[1] bg-white'>
      ...
      <Header
        ...
        signupCSS='button hidden rounded-[50px] border-white bg-black text-white after:bg-colorOrangyRed hover:border-colorOrangyRed hover:text-white lg:inline-block'
      />
      {/*...::: Header End :::... */}
